...
import 'package:workampus/screens/jobProviderApp/contractsTab/pending/pendingContractDetail_view.dart';
...
class PendingContractWidget extends StatelessWidget {
  ...
  PendingContractWidget(
      {this.pendingContract, this.jobSeeker});
              ...
              Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) => PendingContractDetailView(
                          contract: pendingContract, user: jobSeeker)));
            },
            child: Column(
              children: [
                ListTile(
