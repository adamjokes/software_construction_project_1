...
import 'package:workampus/screens/jobProviderApp/contractsTab/completed/completedContract_widget.dart';
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return CompletedContractWidget(
                              ...
                              contractor: model.getContractor(
                                  completedContract.contractorID),
                              currUser: model
                                  .getCurrUser(completedContract.currUserID),
