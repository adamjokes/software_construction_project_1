...
class ContractJPView extends StatefulWidget {
  const ContractJPView({this.tab, this.initialIndex});
  final int tab;
  final int initialIndex;
  @override
  _ContractJPViewState createState() => _ContractJPViewState();
}

class _ContractJPViewState extends State<ContractJPView>
