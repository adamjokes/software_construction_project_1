...
import 'package:workampus/screens/jobProviderApp/contractsTab/ongoing/ongoingContractDetail_view.dart';
...
class OngoingContractWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //determine status
    Text _status;
    if (ongoingContract.pendingComplete && !ongoingContract.pendingPayment) {
      _status = Text(
        ' - payment pending!',
        style: TextStyle(
            color: accentColor,
    ...
    } else if (ongoingContract.pendingPayment) {
      _status = Text(
        ' - pending completed ✓',
        style: TextStyle(
