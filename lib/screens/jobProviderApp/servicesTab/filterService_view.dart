...
class FilterServiceView extends StatefulWidget {
  ...
  final bool et2;
  @override
  _FilterServiceViewState createState() => _FilterServiceViewState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<ServiceViewModel>.reactive(
      ...
      builder: (context, model, child) => Scaffold(
        appBar: buildSectionBar(context, 'Filter Service'),
        body: Container(
          height: screenHeight,
          child: Column(
            children: <Widget>[
              ...
              Padding(
                ...
                child: transparentButton("Filter", () async {
                  ...
                  if (ut1 == false &&
                      ...
                      et1 == false &&
                      et2 == false) {
                    awesomeToast('Please select any service type');
                  } else {
