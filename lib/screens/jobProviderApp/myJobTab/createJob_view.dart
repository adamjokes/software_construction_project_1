...
class _OfferServiceScreenState extends State<OfferServiceScreen> {
  ...
  final jobRateController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<MyJobViewModel>.reactive(
      ...
      builder: (context, model, child) => Scaffold(
        ...
        appBar: buildSectionBar(context, 'Create Job'),
        body: Stack(
          children: [
            Container(
              height: screenHeight,
                ...
                child: ListView(
                  children: [
                    ...
                    Padding(
                      ...
                      child: transparentButton("Create Job", () async {
                        var newRate;
