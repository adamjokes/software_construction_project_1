        ...
        body: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: transparentButton("Cancel Application", () async {
                awesomeDialog(
                  context,
                  'Are you sure?',
                  'Once you cancel this application, job provider will not be able to see your applications again.\n\nComfirm Cancel Application?',
                  () async {
                    model.deleteContract(id: widget.contract.id);
                    await Future.delayed(Duration(seconds: 1));
                    awesomeToast('Application\'s Cancelled!');

                    Navigator.of(context, rootNavigator: true)
                        .pushAndRemoveUntil(
                            MaterialPageRoute(
                                builder: (context) =>
                                    JobSeekerHome(tab: 2, contractIndex: 0)),
                            (route) => false);
                  },
                );
