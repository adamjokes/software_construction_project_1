...
class _CompletedContractDetailViewState
  ...
  void initState() {
    super.initState();
    if (!widget.contract.isReviewedByJP && !widget.contract.isReviewedByJS) {
      notRated = true;
    } else if (widget.contract.isReviewedByJP &&
                    ...
                    children: [
                      ...
                      Container(
                        padding: EdgeInsets.only(
                            bottom: widget.contract.isReviewedByJS ? 16 : 20,
                            left: 15,
                            right: 15,
                            top: widget.contract.isReviewedByJS ? 0 : 12.5),
                        color: bgColor,
                        child: widget.contract.isReviewedByJS
                            ? Column(
