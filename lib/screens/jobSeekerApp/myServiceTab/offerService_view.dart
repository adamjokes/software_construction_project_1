...
class OfferServiceScreen extends StatefulWidget {
  const OfferServiceScreen({this.tab});
  final int tab;
...
class _OfferServiceScreenState extends State<OfferServiceScreen> {
  ...
  final serviceChargController = TextEditingController();
  final serviceAvaiController = TextEditingController();
  ...
  String selectedCtg = 'University Jobs';
  String selectedType = 'Documentation and Editing';
  ...
  Widget build(BuildContext context) {
    ...
    return ViewModelBuilder<MyServiceViewModel>.reactive(
      ...
      builder: (context, model, child) => Scaffold(
        ...
        appBar: buildSectionBar(context, 'Offer Service'),
        body: Stack(
          children: [
            Container(
              height: screenHeight,
                ...
                child: ListView(
                  children: [
                    ...
                    Padding(
                      ...
                      child: transparentButton("Offer Service", () async {
                        var newRate;
                      ...
                      }, botttomBarColor, bgColor, screenWidth - 30),
                    ),
                  ],
                ),
              ),
