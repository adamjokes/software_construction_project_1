...
import 'myServiceDetails/myServiceDetail_view.dart';
...
class OfferedServiceWidget extends StatelessWidget {
  ...
  OfferedServiceWidget({this.offeredService});
        ...
        child: InkWell(
            onTap: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => MyServiceDetailView(offeredService: offeredService)));
            },
            child: Column(
              children: [
                ListTile(
